...
type StepId = 'questions' | 'upload' | 'scan' | 'schema' | 'analysis' | 'complete' | (string & {});
...
const STEP_ICONS: Record<'questions' | 'upload' | 'scan' | 'schema' | 'analysis' | 'complete', any> = {
...
const STEP_COLORS: Record<'questions' | 'upload' | 'scan' | 'schema' | 'analysis' | 'complete', string> = {
      ...
      <CardContent>
        <div className="space-y-4">
          {steps.map((step, index) => {
            const IconComponent = (STEP_ICONS as Record<string, any>)[step.id] || Circle;
              ...
              >
                ...
                <div className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center ${
                  isCompleted 
                    ...
                    : isActive
          ? `${(STEP_COLORS as Record<string, string>)[step.id]} text-white`
