...
type SuggestionCategory = keyof typeof SUGGESTED_QUESTIONS;
...
export function QuestionCollection({ 
  ...
  const [selectedSuggestionCategory, setSelectedSuggestionCategory] = useState<SuggestionCategory>('sales');
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex flex-wrap gap-2">
              {Object.keys(SUGGESTED_QUESTIONS).map(category => (
                <Button
                  ...
                  size="sm"
                  onClick={() => setSelectedSuggestionCategory(category as SuggestionCategory)}
            ...
            <div className="grid gap-2">
              {SUGGESTED_QUESTIONS[selectedSuggestionCategory].map((suggestion: string, index: number) => (
                <div
                  key={index}
