...
export default function PayPerAnalysis({ onBack }: PayPerAnalysisProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
              ...
              <div className="space-y-4">
                <Button 
                  size="lg"
                  className="w-full bg-gray-800 hover:bg-gray-900 text-white px-8 py-4"
                ...
                <div className="space-y-3">
                  <Button 
                    size="lg"
                    variant="outline"
                    className="w-full border-gray-200 hover:border-gray-400 hover:bg-gray-50"
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="border-t pt-3 mt-4">
                        <div className="flex justify-between text-lg font-bold text-slate-900">
                          ...
                          <span className="text-gray-800">${calculatedPrice}</span>
                        </div>
                      </div>
                    </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 border border-slate-300 rounded-md text-sm focus:ring-gray-500 focus:border-gray-500"
                        />
                      </div>
                      <div className="flex items-center justify-between">
                        <a
                ...
                <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                  <div className="flex items-start">
                    <Brain className="w-5 h-5 text-gray-600 mr-3 mt-0.5" />
                    <div>
                      <h5 className="font-medium text-gray-900 mb-1">Why Choose Your Own Provider?</h5>
      ...
      {/* CTA Section */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-gray-700 to-gray-800">
        <div className="max-w-4xl mx-auto text-center">
