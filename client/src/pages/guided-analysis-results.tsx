...
const GuidedAnalysisResults: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="h-screen bg-gray-50 py-4 flex items-center justify-center">
  ...
  return (
    <div className="h-screen bg-gray-50 py-4 flex flex-col">
      <div className="max-w-4xl mx-auto px-4 flex-1 overflow-auto">
        {/* Header */}
        <div className="mb-4">
