...
export default function AuthPage({ onLogin }: AuthPageProps) {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Panel - Branding */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-gray-100 to-gray-200 p-12 flex-col justify-center items-center text-gray-800">
        {/* Data visualization background */}
        <div className="bg-gray-300/20 backdrop-blur-sm rounded-2xl p-8 mb-8 w-full max-w-md">
          <div className="grid grid-cols-4 gap-4 mb-6">
            <div className="h-16 bg-gray-400/30 rounded-lg flex items-end p-2">
              <div className="w-full h-8 bg-gray-500/40 rounded"></div>
            </div>
            <div className="h-16 bg-gray-400/30 rounded-lg flex items-end p-2">
              <div className="w-full h-12 bg-gray-500/40 rounded"></div>
            </div>
            <div className="h-16 bg-gray-400/30 rounded-lg flex items-end p-2">
              <div className="w-full h-6 bg-gray-500/40 rounded"></div>
            </div>
            <div className="h-16 bg-gray-400/30 rounded-lg flex items-end p-2">
              <div className="w-full h-10 bg-gray-500/40 rounded"></div>
            </div>
          </div>
