    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10">
          ...
          <div className="absolute top-40 right-20 w-16 h-16 bg-gray-300/30 rounded-full animate-bounce" style={{animationDelay: '1s'}}></div>
          <div className="absolute bottom-20 left-1/4 w-12 h-12 bg-gray-400/30 rounded-full animate-pulse" style={{animationDelay: '2s'}}></div>
        </div>
        
        <div className={`max-w-6xl mx-auto text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <Badge className={`mb-6 bg-gray-100 text-gray-700 border-gray-200 transition-all duration-700 hover:scale-105 ${isVisible ? 'animate-bounce' : ''}`}>
            <Sparkles className="w-4 h-4 icon-gap animate-spin" style={{animationDuration: '3s'}} />
          ...
          <h1 className={`text-5xl md:text-6xl font-bold text-slate-900 mb-6 leading-tight transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-600 to-gray-800 animate-pulse">
              data expert
            </span>
          ...
          <div className={`flex flex-col sm:flex-row gap-4 justify-center mb-12 transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <Button 
              ...
              className="bg-gradient-to-r from-gray-700 to-gray-800 text-lg px-8 py-6 hover:scale-105 transition-all duration-200 hover:shadow-xl hover:from-gray-800 hover:to-gray-900 border-2 border-transparent hover:border-gray-400"
            >
            ...
            <Button 
              ...
              variant="outline"
              onClick={onGetStarted}
              className="text-lg px-8 py-6 hover:scale-105 transition-all duration-200 border-2 border-gray-200 hover:border-gray-400 hover:bg-gray-50"
            >
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <div className="flex justify-between items-center mt-6 pt-4 border-t">
                      ...
                      >
                        <ArrowRight className="w-4 h-4 icon-gap" />
                        Next Scenario
                      </Button>
              ...
              <Card className="bg-gradient-to-br from-green-50 to-blue-50 border-green-200">
                <CardHeader>
                  <CardTitle className="flex items-center text-green-800">
                    <TrendingUp className="w-5 h-5 icon-gap" />
