...
- If asking about "location" and data has address columns: hasMatchingEntities: true, relevantColumns: ["address", "city", "state"]`;
    ...
    try {
      ...
      // Use the Anthropic client directly for fallback analysis
      ...
      const response = fallbackResponse.content[0].type === 'text' ? fallbackResponse.content[0].text : '{"error": "Unable to analyze"}';
